                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 col-12 fs-1">
                            <div class="mb-6 mb-lg-0 fs-6">
                                <div class="icon-shape icon-lg mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                                        <style>
                                            svg {
                                                fill: #ff8000
                                            }
                        ...
                        <div class="col-md-6 col-lg-3 col-12">
                            <div class="mb-6 mb-lg-0 fs-6">
                                <div class="icon-shape icon-lg mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 448 512">
                                        <style>
                                            svg {
                                                fill: #ff8000
                                            }
                        ...
                        <div class="col-md-6 col-lg-3 col-12">
                            <div class="mb-6 mb-lg-0 fs-6">
                                <div class="icon-shape icon-lg mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 576 512">
                                        <style>
                                            svg {
                                                fill: #ff8000
                                            }
                        ...
                        <div class="col-md-6 col-lg-3 col-12">
                            <div class="mb-6 mb-lg-0 fs-6">
                                <div class="icon-shape icon-lg mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 640 512">
                                        <style>
                                            svg {
                                                fill: #ff8000
                                            }
